!function(){
    ...
    // ======== 配置 ========
    const c={
        s:t?.getAttribute('data-s')||'https://your-shop.com',
    ...
    function z(p){
        ...
        T.innerHTML=`
            ...
            <p style="margin:0;color:#d44000"><strong>${Lang.price}${+p.pr}</strong></p>
            <span style="padding:10px 18px;background:#0077cc;color:#fff;border-radius:6px;text-align:center;font:bold 0.95em sans-serif;cursor:pointer">${Lang.action}</span>
        `;
