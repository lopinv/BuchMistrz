		...
		<div class="wf_header-navwrapper">
			<div class="wf_header-navwrapperinner">
				...
				<div class="wf_navbar wf-d-none wf-d-lg-block">					
					...
					<div class="wf_navbar-wrapper <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','eazyshop'); endif; ?>">
						<div class="wf-container">
							<div class="wf-row align-items-center">
								...
								<?php endif; ?>
								<div class="wf-col-lg-<?php if(!class_exists( 'woocommerce' ) || $shopire_hs_hdr_bcat !=='1'): esc_attr_e('12','eazyshop'); else: esc_attr_e('9','eazyshop'); endif; ?> wf-col-12">
				...
				<div class="wf_mobilenav wf-d-lg-none <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','eazyshop'); endif; ?>">
